    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md backdrop-blur-lg bg-white/10 border-white/20 shadow-2xl">
        <CardHeader className="text-center space-y-4">
          ...
          <p className="text-gray-300">Create your account and start yapping!</p>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="relative">
            ...
            <span className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 px-2 text-gray-300 text-sm">
              or
            </span>
          </div>
